...
/* Website Setting */
$config = array(
    'site_url' => 'https://itemnoob.com/', // โดเมนหลัก (ไม่ต้องมี / ปิดท้าย)
    'charset_language' => 'UTF-8',
);
    
/* Database Setting */
$db_host = "localhost";// Host for connent database
$db_username = "admin"; // Username for connent database
$db_password = "Da20617"; // Password for connent database
